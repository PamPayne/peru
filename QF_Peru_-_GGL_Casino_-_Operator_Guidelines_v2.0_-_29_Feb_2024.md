...
source_file: QF Peru - GGL Casino - Operator Guidelines v2.0 - 29 Feb 2024.pdf
...
|---|---|---|---|
| 0.01 | 22 February 2024 | John Crofton | Initial Draft |
| 0.02 | 29 February 2024 | John Crofton | Updated |
...
| Responsible Gaming | (including deposit limits, bet limits, self- exclusions, and time-outs) | Yes | No |
| Responsible Gaming | Playcheck | Yes | Yes |
...
| Back Office | Free Spins | Yes | No |
| Back Office | Tournaments | Yes | Yes |
...
Please ensure that your websites providing online games in this market have a Peru domain. The regulations advise the following domains would be permissible: ".bet.pe", ".bet", ".com", ".pe" or ".com.pe".
...
We will provide a minimum of 30 days’ worth of detailed game transaction history. The regulations specify that 2 years data must be available to the player, but this can be delivered upon request. When specifying a data request from Games Global Limited, please also include “Game Type” as part of the data to be collected.
...
Note: You are required to advise your players regarding this on your Terms and Conditions page.
